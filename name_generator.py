...
######
"""Chcemy wygenerować teksty typu:

 "Jan z Gdańska wygrywa właśnie nagrodę 1000 zł!"
 "Barbara z Krakowa wygrywa właśnie nagrodę 6000 zł!"
 
 Listy z imionami i miastami są w zdefiniowane powyżej. Wylosuj imię i miasto z powyższych oraz kwotę w tysiącach i
 uzupełnij tekst w zmiennej 'title'
